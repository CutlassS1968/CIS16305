...
public class StudentList
{
    ...
    // Student[] friends = new Student[8];
		...
		Collections.sort(friends, new SortByLastThenFirst());
		System.out.println("Friends, sorted by last name\n" +
				friends);
		...
		ArrayList<Student> lista = (ArrayList<Student>)friends.stream()
				.filter(arg -> arg.getFirstName().equals("Barnes"))
...
class SortByLastThenFirst implements Comparator<Student> {
